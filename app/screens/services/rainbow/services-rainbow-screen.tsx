...
const PHONE = '+34 964 729 102';
const WEB_URL = 'https://www.uji.es/serveis/ui/puntvioletarainbow/base/rainbow/';
const MAP_URL =
...
const IMG_SRC = require('../../../../assets/img/servicios/logoServicios/logo_servicio_1_y_2.jpg');

export const ServicesRainbowScreen: FC<
  NativeStackScreenProps<NavigatorParamList, 'servicesRainbow'>
> = ({navigation}) => {
  ...
  return (
    <Screen
      ...
      <View style={{width: '66%', alignSelf: 'center', aspectRatio: 1.031688}}>
        <Image
          source={IMG_SRC}
          style={{
            width: '100%',
      ...
      <View style={{marginTop: spacing.xxlarge}}>
        <Text
          tx="servicesRainbowScreen.description"
