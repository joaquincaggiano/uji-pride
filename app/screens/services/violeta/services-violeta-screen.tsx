...
const EMAIL = 'puntvr@uji.es';
const PHONE = '+34 964 729 039';
const WEB_URL = 'https://www.uji.es/serveis/ui/puntvioletarainbow/base/violeta/';
const MAP_URL =
...
export const ServicesVioletaScreen: FC<
  NativeStackScreenProps<NavigatorParamList, 'servicesVioleta'>
> = ({navigation}) => {
  ...
  return (
    <Screen
      ...
      <View style={{marginTop: spacing.xxlarge}}>
        <Text
          tx="servicesVioletaScreen.description"
